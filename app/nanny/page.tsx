...
export default async function NannyPage() {
  ...
  return <AppShell activePath="/nanny" user={user}><div className="content-wrap app-page"><div className="page-heading"><div><p className="eyebrow">Équipe de la famille</p><h1>{t("nanny.title")}</h1><p className="page-subtitle">{t("nanny.subtitle")}</p></div></div><NannyManager nannies={nannies} /></div></AppShell>;
}
